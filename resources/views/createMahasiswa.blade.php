...
<form class="form-horizontal" action="/action_page.php">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="nim" class="form-control" id="nim" placeholder="NIM" name="nim">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="tanggal_lahir">Tanggal Lahir:</label>
    <div class="col-sm-10">
      <input type="tanggal_lahir" class="form-control" id="tanggal_lahir" placeholder="2021-02-02" name="ttl">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="tahun_masuk">Tahun Masuk:</label>
    <div class="col-sm-10">
      <input type="tahun_masuk" class="form-control" id="tahun_masuk" placeholder="tahun_masuk" name="tahun">
    </div>
  </div>
  <div class="form-group">
